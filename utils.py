...
def save_model(args, epoch, model, model_without_ddp, optimizer_gn, optimizer_dt, loss_scaler, model_ema=None):
    ...
    for checkpoint_path in checkpoint_paths:
        to_save = {
            ...
            'optimizer_dt': optimizer_dt.state_dict(),
            'epoch': epoch,
...
def auto_load_model(args, model, model_without_ddp, optimizer_gn, optimizer_dt, loss_scaler, model_ema=None):
    output_dir = Path(args.output_dir)
    ...
    if args.resume:
        ...
        if 'optimizer_gn' in checkpoint and 'optimizer_dt' in checkpoint and 'epoch' in checkpoint:
            optimizer_gn.load_state_dict(checkpoint['optimizer_gn'])
            optimizer_dt.load_state_dict(checkpoint['optimizer_dt'])
